...
export default function Navbar() {
  ...
  return (
    <nav className={cn(
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="absolute top-full left-0 w-full h-[100vh] bg-white border-b border-slate-200 py-2 p-6 flex flex-col gap-4 md:hidden animate-in slide-in-from-top text-slate-900 text-right z-[9999]">
          ...
          <div className="p-8 border-t border-t-slate-200 flex flex-col items-end text-right w-full">        
